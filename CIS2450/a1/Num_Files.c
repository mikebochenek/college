/* -------------------------------------------------------------------------
   ...
   FileName: Num_Files.c  
   Function: Num_Files - returns the number of "readable" files in the
             directory specified by 'dirname'
   Parameters: 'dirname' is a pointer to array of characters that specifies
               the directory name.
   Return values: Returns the number of "readable" files in 'dirname'.
                  -1 is returned if the directory cannot be opened for any
                  reason, or if 'dirname' doesn't point to anything.  
   ------------------------------------------------------------------------- */
#include "CIS245.h"
