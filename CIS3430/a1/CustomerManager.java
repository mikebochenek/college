...
public class CustomerManager extends JPanel {
   ...
   private void buildCustomerTab() {
      ...
      gridbag.setConstraints (sexCombo, c);
		...
		c.gridwidth = 1;
		c.anchor = GridBagConstraints.EAST;
      JLabel moneyLabel = new JLabel ("Money spent:", JLabel.RIGHT);
		...
		emailButton.addActionListener (new ActionListener() 
         {
            public void actionPerformed (ActionEvent e)
            {
               ...
               for (int i = 0; i < queryResults.size(); i++)
               {
               	...
               	entireEmail += "From: info@buy.com\n";
               	entireEmail += "To: ";
               	entireEmail += customerData.getField ( (String) queryResults.elementAt(i), 3);
               	entireEmail += "\n";
               	entireEmail += "Date: February 19, 2000\n";
						entireEmail += "Subject: Special Offer!\n";
               	entireEmail += "\n";
               	entireEmail += emailText.getText();
           
			         System.out.println ("===== SIMULATING E-MAIL SEND =====");
                  System.out.println (entireEmail);
			         System.out.println ("===== END E-MAIL SEND =====");
               }
			   }
		   }
   ...
   public static void main(String s[]) 
	{
	   // GIVE HER!
      CustomerManager panel = new CustomerManager();
