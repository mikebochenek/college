...
public class RemoteProductManager extends JPanel {
   // main frame that holds everything, ie main window
   static JFrame frame;

   // productData is the tree for all the products
   private RemoteDatabaseInterface productData;
   ...
   public RemoteProductManager()
   {
      ...
      productData = new RemoteDatabaseInterface("product.txt");
   ...
   {
      // GIVE HER!
      RemoteProductManager panel = new RemoteProductManager();
